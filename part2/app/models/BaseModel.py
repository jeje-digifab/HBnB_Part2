...
class BaseModel:
    """
    A base model class that provides unique identification and
    timestamping for instances.
    ...
    def __init__(self):
        ...
        Generates a unique id using UUID and sets created_at and updated_at
    ...
    def update(self, data: dict) -> None:
        ...
        Args:
            data (dict): A dictionary containing attribute names and
            their new values.

        Updates only the attributes that exist in the object, and calls save()
    ...
    def __repr__(self):
        ...
        Returns:
            ...
            including class name, id, created_at, and updated_at timestamps.
        """
        return (
